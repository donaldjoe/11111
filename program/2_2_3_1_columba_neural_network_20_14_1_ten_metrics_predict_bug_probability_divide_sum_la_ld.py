...
filepath = 'J:/genetic_algorithm/data_processing/data_spilite_into_ten_fold_output/columba/columba_data_first_taking_natural_logarithms_second_max_min_normalization/'
...
train_filename_list = ['columba_train_dataset_first_fold_1','columba_train_dataset_second_fold_2','columba_train_dataset_third_fold_3','columba_train_dataset_fourth_fold_4', 'columba_train_dataset_fifth_fold_5','columba_train_dataset_sixth_fold_6','columba_train_dataset_seventh_fold_7','columba_train_dataset_eighth_fold_8', 'columba_train_dataset_ninth_fold_9','columba_train_dataset_tenth_fold_10']
test_filename_list = ['columba_test_dataset_first_fold_1','columba_test_dataset_second_fold_2','columba_test_dataset_third_fold_3','columba_test_dataset_fourth_fold_4','columba_test_dataset_fifth_fold_5','columba_test_dataset_sixth_fold_6','columba_test_dataset_seventh_fold_7','columba_test_dataset_eighth_fold_8', 'columba_test_dataset_ninth_fold_9','columba_test_dataset_tenth_fold_10']
...
#    print(train_datasets_zero_final)
    ...
    #将数据集中的行号作为训练集的输出，数据集中的行号在第20列，也就是最后一列
...
project_name = 'columba_recall_10_20_10_1_150_test_three_layers_bug_probo_divide_sum_la_ld_nn'   
...
"""文件路径的拼接,list的长度为6"""
""""拼接测试集原始的数据集"""
"""拼接成J:/genetic_algorithm/data_processing/my_nn_model_original_test_data_density/bugzilla/的形成"""
...
"""文件名的拼接，对降序排序的测试集和预测的缺陷密度降序排序拼接成文件名，使文件都带有后缀，拼接成bugzilla_test_dataset_density_decent_orderby_density_first_fold_1.xls带有后缀的形式"""
...
"""获取当前想要保存的原始的测试集和预测输出的bug/la+ld(defect density)的按照降序排序之后的文件路径"""
...
for i in range(len(my_nn_model_original_test_dataset_predict_density_global)):   
    #tem_my_neural_row = my_neural_network_exp_result_global[i]
    #取得list中第一列的数值 current_file_save_path_columba
    current_file_path = current_file_save_path_columba
    current_file_name = current_test_data_density_file_suffix_name_columba[i]
...
for i in range(len(my_nn_model_test_dataset_density_decent_orderby_predict_density_global)):   
    #tem_my_neural_row = my_neural_network_exp_result_global[i]
    #取得list中第一列的数值
    current_decent_file_path = current_decent_file_save_path_columba
    current_decent_file_name = current_decent_test_data_density_file_suffix_name_columba[i]
