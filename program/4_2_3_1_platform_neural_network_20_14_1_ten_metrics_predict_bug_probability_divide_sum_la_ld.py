...
filepath = 'J:/genetic_algorithm/data_processing/data_spilite_into_ten_fold_output/platform/platform_data_first_taking_natural_logarithms_second_max_min_normalization/'
...
train_filename_list = ['platform_train_dataset_first_fold_1','platform_train_dataset_second_fold_2','platform_train_dataset_third_fold_3','platform_train_dataset_fourth_fold_4', 'platform_train_dataset_fifth_fold_5','platform_train_dataset_sixth_fold_6','platform_train_dataset_seventh_fold_7','platform_train_dataset_eighth_fold_8', 'platform_train_dataset_ninth_fold_9','platform_train_dataset_tenth_fold_10']
test_filename_list = ['platform_test_dataset_first_fold_1','platform_test_dataset_second_fold_2','platform_test_dataset_third_fold_3','platform_test_dataset_fourth_fold_4','platform_test_dataset_fifth_fold_5','platform_test_dataset_sixth_fold_6','platform_test_dataset_seventh_fold_7','platform_test_dataset_eighth_fold_8', 'platform_test_dataset_ninth_fold_9','platform_test_dataset_tenth_fold_10']
...
project_name = 'platform_recall_10_20_10_1_150_test_three_layers_bug_probo_divide_sum_la_ld_nn'   
...
for i in range(len(my_nn_model_original_test_dataset_predict_density_global)):   
    #tem_my_neural_row = my_neural_network_exp_result_global[i]
    #取得list中第一列的数值
    current_file_path = current_file_save_path_platform
    current_file_name = current_test_data_density_file_suffix_name_platform[i]
...
for i in range(len(my_nn_model_test_dataset_density_decent_orderby_predict_density_global)):   
    #tem_my_neural_row = my_neural_network_exp_result_global[i]
    #取得list中第一列的数值
    current_decent_file_path = current_decent_file_save_path_platform
    current_decent_file_name = current_decent_test_data_density_file_suffix_name_platform[i]
